  ...
  container_definitions = jsonencode([
    {
      ...
      command = ["/bin/bash", "-c", join(" ", [
        ...
        "sed -i 's/SOLR_REPLICATION_LEADER_URL/https:\\/\\/${local.leader_domain}\\/solr\\/ckan\\/replication/g' /tmp/ckan_config/solrconfig.txt",
        "sed -i 's/SOLR_REPLICATION_LEADER_USER/${random_uuid.username.result}/g' /tmp/ckan_config/solrconfig.txt",
        "sed -i 's/SOLR_REPLICATION_LEADER_PASSWORD/${random_password.password.result}/g' /tmp/ckan_config/solrconfig.txt",
